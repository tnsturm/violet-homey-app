...
// Cast to an index signature (checkJs strict, M5 gate c): targets are looked up by
// a dynamic string key and the arg-spec shapes are heterogeneous/validated at runtime.
const WRITE_TARGETS = /** @type {Object<string, *>} */ ({
  PUMP: {
    token: 'PUMP',
    states: ['AUTO', 'ON', 'OFF'],
    argSpecs: [
...
/** @param {Object<string, *>} spec @param {*} value @returns {?string} */
 ...
 * @param {{target:string, scene?:number, state:string, args?:Object<string, *>}} cmd Command;
