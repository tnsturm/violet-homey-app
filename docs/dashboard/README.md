...
- Zwischen-Milestone-Checkpoints (`Mx.0` „Housekeeping Agentic Loop", CLAUDE.md §7 Punkt 4)
  stehen als eigene, milestone-förmige Einträge in derselben Liste, direkt vor dem
  Implementierungs-Milestone (`Mx.1`), den sie gaten.
